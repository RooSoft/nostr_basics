defmodule NostrBasics.Models.Repost.Convert do
  @moduledoc """
  ...
  ## Examples
      ...
      ...> |> NostrBasics.Models.Repost.Convert.to_event(<<0x5ab9f2efb1fda6bc32696f6f3fd715e156346175b93b6382099d23627693c3f2::256>>)
      {
        :ok,
        %NostrBasics.Event{
